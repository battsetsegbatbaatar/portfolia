...
export default function Home() {
  return (
    <>
      <header>
        <container className="headerPosition">
          <h1>{"<SS />"}</h1>
          <nav className="containerNavPosi navFont">
            <a>About</a>
            <a>Work</a>
            <a>Testimonials</a>
            <a>Contact</a>
      ...
      <main className="mainPosi">
        <div className="read">
          <div className="mainConPosi">
            <div className="gap8">
              <h1 className="titleFont">Hi, I’m Sagar 👋</h1>
              <p className="navFont">
        ...
        <img className="image1" src="./Pic.png"></img>
      </main>
    </>
  );
}
