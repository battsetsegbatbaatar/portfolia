  ...
  en: [
    ...
    },
    {
      ...
      highlights: [
        ...
        "Integrated QPay, Golomt Bank, and Khan Bank payment gateways with both subscription and one-time order flows",
        "Added real-time notifications and chat functionality using Firebase push notifications and Socket.io",
