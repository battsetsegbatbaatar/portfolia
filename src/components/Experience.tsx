...
const histories = {
  en: [
    ...
    },
    {
      ...
      highlights: [
        "Participated in data analysis and processing tasks",
      ],
    },
  ],
  mn: [
            ...
            <div key={i} className="flex flex-col gap-3 pl-4 border-l-2 border-gray-200 dark:border-gray-700">
              <div className="flex flex-col gap-1">
                <div className="flex items-center justify-between flex-wrap gap-2">
                  <span className="font-semibold text-gray-900 dark:text-white">{h.company}</span>
                  <span className="text-xs text-gray-400 dark:text-gray-500 font-mono">{h.period}</span>
                </div>
                <span className="text-sm text-gray-500 dark:text-gray-400">{h.position}</span>
              </div>
